...
function PANEL:Init()
	...
	self.StencilPlayerModel:SetMouseInputEnabled(false)
	self.StencilPlayerModel:SetKeyboardInputEnabled(false)
	...
	self.skeleton:SetMouseInputEnabled(false)
	self.skeleton:SetKeyboardInputEnabled(false)
	self:MakePopup()
end
